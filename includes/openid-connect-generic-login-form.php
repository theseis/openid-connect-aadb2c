...
class OpenID_Connect_Generic_Login_Form {
	...
	static public function register( $settings, $client_wrapper ){
		...
		//add_filter( 'login_message', array( $login_form, 'handle_login_page' ), 99 ); // Disable button on login form
	...
	function handle_redirect_login_type_auto()
	{
		if ( //$GLOBALS['pagenow'] == 'wp-login.php'
			(($_SERVER["REQUEST_URI"] == '/mon-compte/' || $_SERVER["REQUEST_URI"] == '/commande/') && !is_user_logged_in())
